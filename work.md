...
- **This summer, I'm a data science intern at** <a href="https://www.hellocherish.com/"> Cherish </a>, where I have created a trending content web tool using `Python`, `Heroku` and `Streamlit`, an open-source app framework for Data Science teams. [App](https://intelligent-vin-24283.herokuapp.com/){:target="_blank" class="button inline-label-page"} I am also working on onboarding algorithms using `Python` to assist the organization's content matching process.
